...
class mnp():
    ...
    def create_mnp(self,pop_type,side):    
        #Create population
        ...
        if side=="LEFT":
            self.motor_neuron_pop = nest.Create('aeif_cond_beta_aeif_cond_beta_nestml',netparams.num_motor_neurons_L,self.tonic_neuronparams)	
        elif side=="RIGHT":
            self.motor_neuron_pop = nest.Create('aeif_cond_beta_aeif_cond_beta_nestml',netparams.num_motor_neurons_R,self.tonic_neuronparams)	
