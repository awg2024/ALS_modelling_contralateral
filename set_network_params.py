...
class neural_network():
    def __init__(self):
        ...
        self.sparsity_custom_v0v_rg_inh = 0.25
        ...
        if freq_test==1:            
            self.I_e_bursting_mean = 120 #pA 300 normal 
            self.I_e_tonic_mean = 320 #pA 480 normal                     
        ...
        self.low_locomotion_v0v_left = args['low_locomotion_v0v_left']
        self.low_locomotion_v0v_right = args['low_locomotion_v0v_right']

        self.high_locomotion_v0v_left = args['high_locomotion_v0v_left']
        self.high_locomotion_v0v_right = args['high_locomotion_v0v_right']

        self.low_locomotion_v0d_left = args['low_locomotion_v0d_left']
        self.low_locomotion_v0d_right = args['low_locomotion_v0d_right']

        self.high_locomotion_v0d_left = args['high_locomotion_v0d_left']
        self.high_locomotion_v0d_right = args['high_locomotion_v0d_right']

        self.ramp_experimental_v0v_weights = args['ramp_experimental_v0v_weights']
        self.ramp_experimental_v0d_weights = args['ramp_experimental_v0d_weights']
