...
#Read spike data
senders_exc2,spiketimes_exc2 = popfunc.read_spike_data(rg1.spike_detector_rg_exc_bursting)
senders_inh2,spiketimes_inh2 = popfunc.read_spike_data(rg1.spike_detector_rg_inh_bursting)
senders_exc_tonic2,spiketimes_exc_tonic2 = popfunc.read_spike_data(rg1.spike_detector_rg_exc_tonic)
senders_inh_tonic2,spiketimes_inh_tonic2 = popfunc.read_spike_data(rg1.spike_detector_rg_inh_tonic)
...
spike_bins_rg_exc2 = popfunc.rate_code_spikes(nn.flx_exc_bursting_count,spiketimes_exc2)
spike_bins_rg_inh2 = popfunc.rate_code_spikes(nn.flx_inh_bursting_count,spiketimes_inh2)
spike_bins_rg_exc_tonic2 = popfunc.rate_code_spikes(nn.flx_exc_tonic_count,spiketimes_exc_tonic2)
spike_bins_rg_inh_tonic2 = popfunc.rate_code_spikes(nn.flx_inh_tonic_count,spiketimes_inh_tonic2)
spike_bins_rg1 = spike_bins_rg_exc2+spike_bins_rg_exc_tonic2+spike_bins_rg_inh2+spike_bins_rg_inh_tonic2
print('Max spike count rg1: ',max(spike_bins_rg1))
...
ax.set_xlim(0,len(spike_bins_rg1))
ax.legend(['rg1'],loc='upper right',fontsize='x-small') 
...
indiv_spikes_exc2,neuron_to_sample_rg1_burst,sparse_count5,silent_count5 = popfunc.count_indiv_spikes(nn.flx_exc_bursting_count,senders_exc2)
indiv_spikes_inh2,neuron_to_sample_rg1_burst_inh,sparse_count6,silent_count6 = popfunc.count_indiv_spikes(nn.flx_inh_bursting_count,senders_inh2)
indiv_spikes_exc_tonic2,neuron_to_sample_rg1_ton,sparse_count7,silent_count7 = popfunc.count_indiv_spikes(nn.flx_exc_tonic_count,senders_exc_tonic2)
indiv_spikes_inh_tonic2,neuron_to_sample_rg1_ton_inh,sparse_count8,silent_count8 = popfunc.count_indiv_spikes(nn.flx_inh_tonic_count,senders_inh_tonic2)
